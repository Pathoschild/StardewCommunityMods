...
REQUIRES SMAPI 0.39+ to be installed!  Version 1.7.0.0.SMAPI is for SMAPI 0.38.  Version 1.6.1.0.SMAPI is for SMAPI 0.37
...
v1.6.1.0.SMAPI
Added hotkeys for time control in-game.
